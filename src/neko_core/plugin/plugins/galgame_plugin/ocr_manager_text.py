    ...
    def _emit_screen_classification_from_extraction(
        ...
        *,
        ...
        try:
            ...
            extraction.warnings.append(f"screen classification vision skipped: {exc}")
            self._screen_awareness_model_detail = "vision_failed"
            self._log_debug("ocr_reader vision screen classification skipped: {}", exc)
        ...
        try:
            ...
            extraction.warnings.append(f"screen classification skipped: {exc}")
            self._screen_awareness_model_detail = "classification_failed"
            self._log_debug("ocr_reader screen classification skipped: {}", exc)
            return ScreenClassification(), False
