...
def test_study_companion_ui_refactor_static_and_hosted_contracts() -> None:
    ...
    if not (plugin_ui_frame_path.exists() and plugin_detail_path.exists()):
        return
    plugin_ui_frame = plugin_ui_frame_path.read_text(encoding="utf-8")
    plugin_detail = plugin_detail_path.read_text(encoding="utf-8")
