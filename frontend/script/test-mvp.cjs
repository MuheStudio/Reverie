...
const electronTests = [
  ...
  'installed-npm-licenses.test.cjs',
  ...
  'macos-app-audit.test.cjs',
  '../script/macos-confirm-error.test.cjs',
  ...
  '../script/package-macos-dmg.test.cjs',
  ...
  'python-command.test.cjs',
  'packaged-python.test.cjs',
  'production-runtime-macos.test.cjs',
